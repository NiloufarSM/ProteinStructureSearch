...
QT_MOC_LITERAL(3, 22, 7), // "options"
QT_MOC_LITERAL(4, 30, 4) // "save"

    },
    "CustomDialog\0setText\0\0options\0save"
};
...
void CustomDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CustomDialog::setText)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void CustomDialog::setText(QString _t1)
{
